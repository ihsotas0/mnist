...
def cross_entropy(pred, actual):
    ...
    pred = np.clip(pred, 1e-64, 1.0 - 1e-64)
...
class NeuralNetwork:
    ...
    def __init__(self, *layers):
        ...
        self.weights = [
            (rng.random((layers[i + 1], layers[i])) - 0.5) * 2  # Just works, IDK
    ...
    def train(self, x, y, max_epochs, min_acc, learning_rate):
        start_time = time()
